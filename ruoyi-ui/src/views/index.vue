<template>
  <div class="app-container home">
    ...
    <div class="nav-container">
      <router-link to="/runda/device" class="nav-link">检测设备管理</router-link>
      <router-link to="/runda/query212" class="nav-link">数据查询</router-link>
      <router-link to="/runda/infor/list" class="nav-link">基础信息管理</router-link>
